...
class FinanceUI:
    ...
    def display_help():
        ...
        print(f"{'fq cs [month/all]':<22} - 📈 Monthly category stats (current month, all time, or by month)")
        ...
        print("9. Stats this month:          fq cs")
        print("10. Stats all time:           fq cs all")
        print("11. Stats by month:           fq cs 04 or 4")
